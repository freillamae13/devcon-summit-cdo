...
function misfit_add_admin() {
	...
	$tt_page = add_object_page($themename, $themename, 'administrator', 'misfit','misfit_options_page', 'dashicons-welcome-widgets-menus');
...
/*										
$options[] = array( "name" => __('Social: Facebook URL','misfitlang'),
...
$options[] = array( "name" => __('Social: Instagram URL','misfitlang'),
			"desc" => "Add Instagram url here",
...
$options[] = array( "name" => __('Social: Spotify URL','misfitlang'),
			"desc" => "Add Spotify url here",
			"id" => $shortname."_spotify",
			"std" => "",
			"type" => "text");

$options[] = array( "name" => __('Social: LinkedIn URL','misfitlang'),
