...
function smlsubform($atts=array()){
	...
	$return = '<form class="sml_subscribe" method="post" id="sml_subscribe_form"><input class="sml_hiddenfield" name="sml_subscribe" type="hidden" value="1"><div class="result"></div>';
	...
	$return .= '<p class="sml_email"><label class="sml_emaillabel" for="sml_email">'.$emailtxt.'</label><input class="sml_emailinput" name="sml_email" placeholder="'.$emailholder.'" type="email" value=""  required autocomplete="off"></p>';
	if ($showsubmit) $return .= '<p class="sml_submit"><input name="submit" class="btn sml_submitbtn" id="submit" type="submit" value="'.($submittxt?$submittxt:'Submit').'"></p>';
	$return .= '</form>';
